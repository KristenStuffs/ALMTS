...
public class RedLivingSpongeBlock extends KelpBlock implements LiquidBlockContainer {
   protected static final VoxelShape SHAPE = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 9.0D, 16.0D);
   @SuppressWarnings("unused")
private static final double growPerTickProbability = 0.14D;

   public RedLivingSpongeBlock(BlockBehaviour.Properties p_54300_) {
      super(p_54300_);
   ...
   protected Block getBodyBlock() {
      return ModBlocks.RED_LIVING_SPONGE_PLANT.get();
   }
