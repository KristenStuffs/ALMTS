...
public class LivingSpongePlantBlock extends KelpPlantBlock implements LiquidBlockContainer {
   public LivingSpongePlantBlock(BlockBehaviour.Properties p_54323_) {
      super(p_54323_);
   }

   protected GrowingPlantHeadBlock getHeadBlock() {
      return (GrowingPlantHeadBlock)ModBlocks.LIVING_SPONGE.get();
   }
